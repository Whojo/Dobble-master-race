...
def sample_images(images: np.ndarray, masks: np.ndarray, nb_samples: int = 50000) -> np.ndarray:
    nb_sample_per_image = nb_samples // len(images)

    sample_pxls = images[0][masks[0]][0] # Initialize arbitrary to be able to use np.vstack
